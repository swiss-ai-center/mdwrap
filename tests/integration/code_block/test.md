This is a sample markdown file with code blocks containing lines longer than 80 characters. The code blocks should not be wrapped and should retain their original formatting.
